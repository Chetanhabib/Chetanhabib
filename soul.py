...
TOKEN = '7439672972:AAHlZ7bCzu5RmXKRqAgDbYgJJAqhaSa8VZE'
...
FORWARD_CHANNEL_ID = --1002166164932
CHANNEL_ID = --1002166164932
error_channel_id = --1002166164932
...
def handle_message(message):
    if message.text == "Instant Plan 🧡":
        ...
        bot.reply_to(message, "*gandu*", parse_mode='Markdown')
